...
The codebase is actively evolving. The public repository is best presented as:

- a working full-stack product prototype
- an automation-heavy systems project
- a strong example of applied AI product engineering

It is not presented as a polished SaaS deployment template.
