...
# 导入 API 路由
from backend.api.v1 import auth, upload, analysis, jobs, history, materials, websocket, resume_optimizer, platforms, statistics, favorites, notifications, feedback, email, candidate_support, market_intelligence
...
app.include_router(candidate_support.router, prefix="/api/v1")
